...
# Check if root
# Since we need to make sure paths are okay we need to run Ansible as a normal
...
echo "This script installs python packages defined in '$PYTHON_REQUIREMNTS_FILE' "
